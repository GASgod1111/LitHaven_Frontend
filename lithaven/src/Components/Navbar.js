...
const Navbar = () => {
  ...
  // const handleCloseBrowserPopover = () => {
    ...
    <>
      <nav>
        ...
        <div className="navbar-links-container">
          <a href="">Home</a>
          <a href="">About</a>
          <a aria-describedby="simple-popover"
      ...
      <BrowsePopover setShowPopOver={setShowBrowsePopup} showPopOver={showBrowsePopup} anchorEl={browseAnchorEl} setAnchorEl={setBrowseAnchorEl}/>
    </>
